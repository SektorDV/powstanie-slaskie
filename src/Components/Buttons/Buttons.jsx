...
const Buttons = () => {
    return (
        <div class="ps__buttons">
            <svg id="icons" class="buttons__video" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 38">
                <defs>
                ...
                <rect class="cls-1" x="18" y="33" width="30" height="2"/><path class="cls-1" d="M13,38a4,4,0,1,1,4-4A4,4,0,0,1,13,38Zm0-6a2,2,0,1,0,2,2A2,2,0,0,0,13,32Z"/>
                <rect class="cls-1" y="33" width="8" height="2"/>
            </svg>
            <svg id="icons" class="buttons__audio" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45.99 38">
                <defs>
                    <style>.cls-1{fill:#6a8594;}</style>
                </defs>
                <title>Inteligentne obiekty wektorowe</title>
                <path class="cls-1" d="M30.49,27.49l-1.42-1.42a10,10,0,0,0,0-14.14l1.42-1.42A12,12,0,0,1,30.49,27.49Z"/>
                <path class="cls-1" d="M34.73,31.73l-1.42-1.42a16,16,0,0,0,0-22.62l1.42-1.42a18,18,0,0,1,0,25.46Z"/>
                <path class="cls-1" d="M39,36l-1.41-1.41a22,22,0,0,0,0-31.12L39,2A24,24,0,0,1,39,36Z"/>
                <path class="cls-1" d="M22.66,0l-13,10H0V28H9.66l13,10H25V0ZM2,12H9V26H2ZM23,35.74,11,26.51v-15L23,2.26Z"/>
            </svg>
            <svg id="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.68 38">
                <defs>
                    <style>.cls-1{fill:#6a8594;}</style>
                </defs>
                <title>Inteligentne obiekty wektorowe</title>
